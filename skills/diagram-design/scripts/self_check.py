...
markup is present — the structural motion contract. This is the installed-skill
check; additional geometry, skin, and motion gates may exist only in a
maintainer checkout and must not be assumed to be available here.
"""
